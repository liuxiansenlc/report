...
--
-- Table structure for table `crop_ph_standard`
--
...
CREATE TABLE `crop_ph_standard` (
  ...
  `crop_code` varchar(50) DEFAULT NULL COMMENT '作物编号',
  `ph_min` decimal(4,2) DEFAULT NULL COMMENT 'PH区间最低',
  `ph_max` decimal(4,2) DEFAULT NULL COMMENT 'PH区间最高',
  `land_use_type` varchar(100) DEFAULT NULL COMMENT '土地利用类型',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='作物种植酸碱度最适区间表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `crop_ph_standard`
--

LOCK TABLES `crop_ph_standard` WRITE;
/*!40000 ALTER TABLE `crop_ph_standard` DISABLE KEYS */;
INSERT INTO `crop_ph_standard` VALUES (1,'番茄','1',5.20,6.50,'旱地',NULL,NULL),(2,'茄子','2',5.50,7.00,'旱地',NULL,NULL),(3,'羊肚菌','3',5.80,7.50,'旱地',NULL,NULL),(4,'白术','4',5.80,7.50,'旱地',NULL,NULL);
/*!40000 ALTER TABLE `crop_ph_standard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `economic_indicator`
--
...
CREATE TABLE `factory_info` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='工厂基础信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `farm_info` (
  ...
  `farm_code` varchar(50) NOT NULL COMMENT '农场编号',
  `farm_name` varchar(100) NOT NULL COMMENT '农场名称',
  `farm_address` varchar(255) DEFAULT NULL COMMENT '农场地址',
  `crop_variety` varchar(100) DEFAULT NULL COMMENT '品种',
  ...
  `longitude` decimal(10,7) DEFAULT NULL COMMENT '农场经度',
  `latitude` decimal(10,7) DEFAULT NULL COMMENT '农场纬度',
  `image_url` varchar(255) DEFAULT NULL COMMENT '农场图片路线',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='农村基础信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `organic_matter_dict`
--
...
CREATE TABLE `organic_matter_dict` (
  ...
  `value_range` varchar(100) DEFAULT NULL COMMENT '数值',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='有机质字典表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `organic_matter_dict`
--

LOCK TABLES `organic_matter_dict` WRITE;
/*!40000 ALTER TABLE `organic_matter_dict` DISABLE KEYS */;
INSERT INTO `organic_matter_dict` VALUES (1,'1级','橙色带黄','极缺乏','0-10',NULL,NULL),(2,'2级','黄色','缺乏','10-20',NULL,NULL),(3,'3级','黄色带绿','中等','20-30',NULL,NULL),(4,'4级','浅绿','较丰富','30-40',NULL,NULL),(5,'5级','深绿色','丰富','＞40',NULL,NULL);
/*!40000 ALTER TABLE `organic_matter_dict` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `service_station` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='服务站基础信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `service_station` VALUES (1,'1','庆元服务点','庆元县姚村','118.898865','27.804916','2026-06-02 16:51:28','2026-06-02 16:51:28');
/*!40000 ALTER TABLE `service_station` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `soil_risk_standard`
--
...
CREATE TABLE `soil_risk_standard` (
  ...
  `ph_range_expr` varchar(100) DEFAULT NULL COMMENT 'pH数值',
  `value_range_expr` varchar(100) DEFAULT NULL COMMENT '数值',
  `land_use_type` varchar(100) DEFAULT NULL COMMENT '土地利用类型',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='重金属风险分级标准表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `soil_risk_standard`
--

LOCK TABLES `soil_risk_standard` WRITE;
/*!40000 ALTER TABLE `soil_risk_standard` DISABLE KEYS */;
INSERT INTO `soil_risk_standard` VALUES (1,'镉','高','≤5.5','≥1.5','旱地',NULL,NULL),(2,'镉','高','5.5＜pH≤6.5','≥2.0','旱地',NULL,NULL),(3,'镉','高','5.5＜pH≤7.5','≥3.0','旱地',NULL,NULL),(4,'镉','高','＞7.5','≥4.0','旱地',NULL,NULL),(5,'镉','中','≤5.5','0.3≤值＜1.5','旱地',NULL,NULL),(6,'镉','中','5.5＜pH≤6.5','0.3≤值＜2.0','旱地',NULL,NULL),(7,'镉','中','5.5＜pH≤7.5','0.3≤值＜3.0','旱地',NULL,NULL),(8,'镉','中','＞7.5','0.3≤值＜4.0','旱地',NULL,NULL),(9,'镉','低','≤5.5','＜0.3','旱地',NULL,NULL),(10,'镉','低','5.5＜pH≤6.5','＜0.3','旱地',NULL,NULL),(11,'镉','低','5.5＜pH≤7.5','＜0.3','旱地',NULL,NULL),(12,'镉','低','＞7.5','＜0.6','旱地',NULL,NULL),(13,'镉','高','≤5.5','≥1.5','水田',NULL,NULL),(14,'镉','高','5.5＜pH≤6.5','≥2.0','水田',NULL,NULL),(15,'镉','高','5.5＜pH≤7.5','≥3.0','水田',NULL,NULL),(16,'镉','高','＞7.5','≥4.0','水田',NULL,NULL),(17,'镉','中','≤5.5','0.3≤值＜1.5','水田',NULL,NULL),(18,'镉','中','5.5＜pH≤6.5','0.43≤值＜2.0','水田',NULL,NULL),(19,'镉','中','5.5＜pH≤7.5','0.6≤值＜3.0','水田',NULL,NULL),(20,'镉','中','＞7.5','0.8≤值＜4.0','水田',NULL,NULL),(21,'镉','低','≤5.5','＜0.3','水田',NULL,NULL),(22,'镉','低','5.5＜pH≤6.5','＜0.4','水田',NULL,NULL),(23,'镉','低','5.5＜pH≤7.5','＜0.6','水田',NULL,NULL),(24,'镉','低','＞7.5','＜0.8','水田',NULL,NULL);
/*!40000 ALTER TABLE `soil_risk_standard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `soil_test_data`
--
...
CREATE TABLE `sys_category` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='业务模块表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,'admin','123456','2026-06-02 16:23:46','2026-06-02 16:23:46');
...
CREATE TABLE `test_report` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='检测报告库';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-11  4:00:13
